...
Короткий опис:  
Бекенд для роботи з аналогом вікіпедії для спорту та кіберспорту, нам необхідним додаток де будуть базові данні про якусь гру чи спорт. Ми маємо гравців, турніри та команди, все інше витікає з цих 3 сутностей
...
Якщо у вас ОС зла, то може бути необхідність видалити entrypoint.sh та строку "RUN chmod +x /app/entrypoint.sh" в Dockerfile для коректного запуску додатку
